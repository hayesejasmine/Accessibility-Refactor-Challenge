...
```
Semantic HTML elements have been added to elimintae repetition and clearly define the structure of the webpage.

The HTML elements follow a logical structure, ensuring that the webpage makes sense and is easy to follow.

Alt attributs have been added to describe the images within the code.
